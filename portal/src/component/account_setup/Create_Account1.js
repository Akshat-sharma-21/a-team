      ...
      <ReallosModal visible="true" modalWidth="620px" modalHeight="391px">
        <div className='container' style={container}>
          ...
          <div className='item2' style={item2}>
            <h1 className='subitem1' style={subitem1} >Account Setup</h1>
    
            <TextField className='subitem2' style={subitem2} variant='outlined' label='Email'></TextField>

            <Button className='subitem3' style={subitem3} variant='contained'>Next
