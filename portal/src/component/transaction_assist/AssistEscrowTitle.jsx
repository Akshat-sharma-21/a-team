...
import { addEscrowTitleTask } from "../../actions/taskActions";
...
/**
 * Implements Escrow-Title tasks, documents, etc.
...
class AssistEscrowTitle extends React.Component {
  ...
  addTask() {
    ...
    this.props.addEscrowTitleTask(this.props.list, newTask, this.props.tid);
...
export default connect(null, mapActionToProps)(AssistEscrowTitle);
