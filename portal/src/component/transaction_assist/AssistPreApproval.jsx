      ...
      <>
        ...
        >
          ...
          <div className="assist-accordion-section-root">
            <div className="assist-accordion-section-heading-group">
              ...
              <span className="assist-accordion-section-status">
                {
                  this.state.taskList.filter(taskItem => taskItem.completed).length
                } of {
            ...
            <div className="assist-task-list-root" style={{ marginTop: 10 }}>
              {this.state.taskList.slice(0, this.state.isEntireTaskListVisible
                ? this.state.taskList.length
                : taskListSplitPoint
              ).map((task) => {
                return (
                  ...
                  >
                    ...
                    <ListItemText>
                      <span className="assist-task-list-item-date">{task.date}</span>
                      <span className="assist-task-list-item-label">{task.name}</span>
                    </ListItemText>
                  </ListItem>
                );
              })}
          ...
          <div className="assist-accordion-section-root">
            <div className="assist-accordion-section-heading-group">
              ...
              <span className="assist-accordion-section-status">
                {
                  this.state.documentsList.filter(docItem => docItem.isFilled).length
                } of {
        ...
        >
          ...
          <div className="assist-add-task-drawer-footer">
            <ReallosButton cta fullWidth onClick={() => this.hideAddTaskDrawer()}>
              Back
            </ReallosButton>
