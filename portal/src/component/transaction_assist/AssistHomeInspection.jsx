...
import { addHomeInspectionTask } from "../../actions/taskActions";

const mapActionToProps = (dispatch) => {
  return bindActionCreators(
    {
      addHomeInspectionTask,
    },
    dispatch
  );
};
 ...
 */
class AssistHomeInspection extends React.Component {
  constructor(props) {
    super(props);
  ...
  addTask() {
    ...
    this.props.addHomeInspectionTask(this.props.list, newTask, this.props.tid);
...
export default connect(null, mapActionToProps)(AssistHomeInspection);
