...
function TasksDashboard() {
      ...
      const _tasks = [
        {
          ...
          description: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit fuga dolorum explicabo quo suscipit nihil minus aspernatur laboriosam. Dolorem cupiditate adipisci voluptates perferendis, facere mollitia at atque magnam maxime cum!',
          actions: [
            {
              label: 'Upload',
              onClick: () => {}
        ...
        },
        {
          ...
          description: 'Morbi vitae tortor metus. Donec vel dignissim ex. Duis nec enim et libero bibendum cursus eu ac lorem. Praesent bibendum lorem non odio auctor aliquet.',
          actions: []
        },
        {
          id: 'zxcvbnm',
          dueDate: '12 Aug',
          title: 'Upload Photo ID',
          description: 'Duis auctor ultrices ex, eu tincidunt libero imperdiet ut. Donec sollicitudin luctus luctus. Pellentesque ut consectetur nunc. Vivamus mauris eros, interdum eu massa id, iaculis malesuada justo.',
          actions: []
        },
      ];
  ...
  const PrimaryContent = () => {
    if (tasksList === null || filteredList === null) {
      ...
      return (
        <div className="single-view-container">
          <h2 className="tasks-subheading">
            Your tasks reside here!
          </h2>

          <p className="tasks-text">
            View all the tasks related to your transaction all in one
            place...
          </p>
        </div>
      )
      ...
      return (
        <div style={{ width: '100%' }}>
          <h2 className="tasks-dashboard-section-title">
            Preapproval
          </h2>
              ...
              <Accordion key={task.id} className="tasks-dashboard-list-item">
                ...
                >
                  ...
                  <div className="tasks-dashboard-list-item-header-text-group">
                    <Typography noWrap className="tasks-dashboard-list-item-heading">
                      {task.title}
                    </Typography>
                    <Typography noWrap className="tasks-dashboard-list-item-subheading">
                      {task.description}
                    </Typography>
                  </div>
                </AccordionSummary>
