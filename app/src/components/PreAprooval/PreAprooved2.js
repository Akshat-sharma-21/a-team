...
function PreAprooved2() {
  return (
    <div>
      <div
        style={{ paddingTop: "20px", marginLeft: "12vw", width: "75%" }}
        id="pbar3"
      >
      ...
      <div style={{ marginTop: "10vh" }}>
        <TextField id="textfield3" variant="outlined" label="Name" />
      </div>

      <div id="arrowicons3" style={{ marginTop: "25vh" }}>
        <ArrowBackIcon id="backicon3"></ArrowBackIcon>
        <ArrowForwardIcon id="forwardicon3"></ArrowForwardIcon>
      </div>
    </div>
  );
}
